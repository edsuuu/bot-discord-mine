...
class StartCommand implements Command {
    public readonly data = new SlashCommandBuilder()
        .setName('start')
        .setDescription('Liga o servidor e avisa quando estiver online');
        ...
        try {
                ...
                await interaction.editReply({
                    embeds: [
                        new EmbedBuilder()
                            ...
                            .setDescription('O servidor já está em funcionamento.')
                            .setTimestamp(),
                    ],
                });
                return;
                ...
                await interaction.editReply({
                    embeds: [
                        new EmbedBuilder()
                            ...
                            .setDescription('O servidor já está sendo iniciado. Aguardando ficar online...')
            ...
            await interaction.editReply({
                embeds: [
                    new EmbedBuilder()
                        ...
                        .setDescription('Aguardando o servidor ficar online. Você será avisado aqui.')
                        .addFields(
            ...
            await interaction.editReply({
                embeds: [
                    new EmbedBuilder()
                        .setColor(0xef4444)
                        .setTitle('❌ Erro ao Ligar o Servidor')
